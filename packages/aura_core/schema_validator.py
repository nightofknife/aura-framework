...
def get_task_schema_validator() -> Optional[fastjsonschema.CodeGeneratorDraft07]:
    ...
    if _task_schema_validator is None:
        schema_path = Path(__file__).parent.parent.parent / 'docs' / 'schemas' / 'task-schema.json'
