        ...
        async with self._engine_lock:
            if self._engine is None:
                ...
                ocr_kwargs = dict(
                    ...
                    doc_orientation_classify_model_dir=r".\plans\aura_base\src\services\ocr_model\PP-LCNet_x1_0_doc_ori",
                    text_detection_model_dir=r".\plans\aura_base\src\services\ocr_model\PP-OCRv5_server_det",
                    text_recognition_model_dir=r".\plans\aura_base\src\services\ocr_model\PP-OCRv5_server_rec",
                    textline_orientation_model_dir=r".\plans\aura_base\src\services\ocr_model\PP-LCNet_x1_0_textline_ori",
                )
                try:
